...
import { COUNTRY_CODES, CountryCode } from '../../../core/models/countyphonecode.models';
import {
  Employee,
  Department,
  Position,
...
getEmployeesByPosition(positionId: string): Observable<PositionEmployeesMainDto> {
  ...
  // Fetch country dialing codes from static model (includes flags and cca2)
  getCountryDialCodes(): Observable<CountryCode[]> {
